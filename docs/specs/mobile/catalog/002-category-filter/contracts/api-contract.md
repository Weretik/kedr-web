...
**Frontend-контракт:** [Admin categories](../../../../../contracts/admin/categories.md)  
...
| Застосувати category до catalog | `GET /api/admin/products` | `categoryId` + існуючий products query | `CatalogPage`             | як у [Admin products](../../../../../contracts/admin/products.md) |

Канонічні request/response наведено у frontend-контракті [Admin
categories](../../../../../contracts/admin/categories.md); private DTO і mapper
